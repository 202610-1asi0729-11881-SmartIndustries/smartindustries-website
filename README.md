...
|-------------|------------|----------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
| 1\.0        | 07/04/2026 | Adrian Fernando Palacios Tinoco                    | Se agregó parte de la estructura del capítulo I del informe, asimismo se agregó la carátula, el startup profile; y antecedentes y problemáticas |
| 1\.1        | 08/04/2026 | Juan David Ayllon Pauccar                          | Se desarrolló la sección 1.1 del documento.                                                                                                     |
| 1\.2        | 09/04/2026 | Juan David Ayllon Pauccar                          | Se redactó la sección 1.2 referente a la solución.                                                                                              |
| 1\.3        | 10/04/2026 | Gabriel Augusto Peñaranda Caldas                   | Se elaboraron las secciones 1.3 y 1.4 del primer capítulo.                                                                                      |
| 1\.4        | 11/04/2026 | Gabriel Augusto Peñaranda Caldas                   | Se finalizó el Capítulo 1 con los puntos restantes.                                                                                             |
| 2\.0        | 12/04/2026 | Gabriel Augusto Peñaranda Caldas                   | Se dio inicio al Capítulo 2 con la redacción de las secciones 2.1 y 2.2.                                                                        |
| 2\.1        | 13/04/2026 | Gabriel Augusto Peñaranda Caldas                   | Se completó la sección 2.3 correspondiente a User Personas.                                                                                     |
| 2\.2        | 14/04/2026 | Limache Coronel Imanol Fabricio                                             | Se elaboró la sección 2.4 (Big Picture Event Storming).                                                                |
| 2\.3        | 15/04/2026 | Limache Coronel Imanol Fabricio                                             | Se redactó la sección 2.5 completando la etapa de diseño conceptual.                                                   |
| 2\.4        | 16/04/2026 | Adrian Fernando Palacios Tinoco                    | Se agregó el Style Guidelines y el Information Architecture.                                                                                    |
| 3\.0        | 17/04/2026 | Limache Coronel Imanol  Fabricio                                             | Se estructuró y brindó apoyo inicial en la redacción de la sección 3.1.                                               |
| 3\.1        | 18/04/2026 | Aldo Jesus Huaman Oscco                            | Se finalizó la sección 3.1 y se avanzó con la sección 3.2.                                                                                      |
| 3\.2        | 19/04/2026 | Aldo Jesus Huaman Oscco                            | Se desarrollaron las secciones 3.3 y 3.4 enfocadas en la gestión del proyecto.                                                                  |
| 3\.3        | 20/04/2026 | Aldo Jesus Huaman Oscco                            | Se finalizó el Capítulo 3 con la redacción de las secciones restantes.                                                                          |
| 4\.0        | 22/04/2026 | Adrian Fernando Palacios Tinoco                    | Se agregó el diagrama de Clases tanto para Frontend como para Backend.                                                                          |
...
<h4>Limache Coronel Imanol Fabricio</h4>
 <b>AV1:</b><p>Presentó la arquitectura de eventos (Big Picture) al equipo y a los stakeholders, explicando el flujo de datos de forma clara.</p>
...
<h4>Huaman Oscco Aldo Jesus</h4>
 <b>AV1:</b><p>Dirigió las reuniones de daily scrum y sustentó el backlog del proyecto ante el product owner y el equipo.</p>
</td>
<td colspan="3" align="justify">
<h4>Limache Coronel Imanol Fabricio</h4>
<b>AV1:</b> Demostró fluidez al explicar conceptos técnicos de Event Storming a un público no técnico.<br><br>
<h4>Peñaranda Caldas Gabriel Augusto</h4>
...
<h4>Huaman Oscco Aldo Jesus</h4>
<b>AV1:</b> Mantuvo una comunicación asertiva y constante, asegurando el alineamiento del equipo durante las exposiciones.
</td>
</tr>
<tr>
...
<td colspan="3" align="justify">
<h4>Limache Coronel Imanol Fabricio</h4>
 <b>AV1:</b><p>Redactó la documentación del Design-Level Event Storming y la conceptualización en el informe técnico del proyecto.</p>
<h4>Peñaranda Caldas Gabriel Augusto</h4>
...
<h4>Huaman Oscco Aldo Jesus</h4>
 <b>AV1:</b><p>Documentó la gestión del proyecto en Jira y estructuró el backlog y el roadmap en el informe final.</p>
</td>
<td colspan="3" align="justify">
<h4>Limache Coronel Imanol Fabricio</h4>
<b>AV1:</b> Produjo documentación técnica coherente y fácil de seguir para facilitar la integración de futuros desarrolladores.<br><br>
<h4>Peñaranda Caldas Gabriel Augusto</h4>
...
<h4>Huaman Oscco Aldo Jesus</h4>
<b>AV1:</b> Mantuvo un registro detallado y ordenado de la planificación, permitiendo una lectura ágil del progreso del proyecto.
</td>
</tr>
</tbody>
</table>
...
Para garantizar la mantenibilidad, legibilidad y colaboración eficiente dentro del equipo, se han adoptado guías de estilo y convenciones de codificación internacionales. Como regla general y de estricto cumplimiento para todos los lenguajes de programación involucrados en la solución (HTML, CSS, JavaScript, TypeScript, Java), **toda la nomenclatura de clases, métodos, variables y comentarios debe realizarse en inglés**.

Adicionalmente, se adoptan las siguientes convenciones estándares:

* **HTML & CSS:** Se siguen los lineamientos de la *Google HTML/CSS Style Guide* y las *HTML Style Guide and Coding Conventions*. Esto asegura un marcado semántico, uso de indentación estándar (2 espacios) y la aplicación de clases descriptivas utilizando *kebab-case*.
* **JavaScript, TypeScript & Angular:** Para el desarrollo frontend, se adopta la *Google TypeScript Style Guide* en conjunto con la *Angular coding style guide*. Esto estandariza el uso de *PascalCase* para clases e interfaces, *camelCase* para variables/métodos, y una estructura modular de componentes, servicios y directivas propia del framework.
* **Java & Spring Boot:** El desarrollo de los RESTful Web Services (Backend) se rige por la *Google Java Style Guide* y las convenciones de *Spring Boot Features*. Se exige un tipado fuerte, uso de *Records* para DTOs, inyección de dependencias mediante constructores y documentación con JavaDocs.
* **Historias de Usuario y Pruebas:** Para las especificaciones y criterios de aceptación, se aplica el estándar *Gherkin Conventions for Readable Specifications* (formato Given-When-Then), permitiendo un lenguaje común entre negocio y desarrollo.

### 5.1.4. Software Deployment Configuration

En esta sección se especifica la configuración de despliegue de la solución, estableciendo los pasos necesarios para publicar los productos digitales en la infraestructura de AWS a partir de los repositorios de código fuente en GitHub, utilizando un enfoque de Integración y Despliegue Continuo (CI/CD) mediante GitHub Actions.

**Despliegue del Landing Page y Frontend Web Application:**
1. Los desarrolladores realizan un `push` a la rama `main` del repositorio correspondiente.
2. GitHub Actions detecta el cambio e inicia el proceso de *build* (compilación de Angular/TypeScript a archivos estáticos optimizados).
3. Tras un *build* exitoso, el pipeline ejecuta las pruebas unitarias.
4. Si las pruebas pasan, los archivos generados se sincronizan automáticamente con un *Bucket* de **Amazon S3**.
5. Finalmente, se invalida la caché de **Amazon CloudFront** (CDN) para que los usuarios finales reciban la versión más reciente a través de una conexión segura (HTTPS).

**Despliegue de los RESTful Web Services (Core Backend API):**
1. Al fusionar cambios en `main`, GitHub Actions ejecuta la compilación del proyecto Java mediante Maven (`mvn clean package`).
2. Se ejecutan las pruebas unitarias y de integración del backend.
3. El artefacto resultante (`.jar`) es empaquetado y enviado a **AWS Elastic Beanstalk**.
4. Elastic Beanstalk provisiona el entorno, actualiza la instancia EC2 sin tiempo de inactividad (*Zero Downtime*) y conecta la aplicación con la base de datos gestionada en **Amazon RDS (MySQL)**.

---

## 5.2. Landing Page, Services & Applications Implementation

En esta sección se explica y evidencia el proceso de implementación, pruebas, documentación y despliegue del Landing Page, Web Services y Frontend Web Applications. El Landing Page permite presentar el modelo de negocio "Asset-Light" y atraer clientes, mientras que los procesos del negocio digital (procesos *core* como el control de accesos, y procesos de soporte como Authentication & Authorization y Subscriptions) están soportados por nuestra solución en Angular y Spring Boot. Todos los productos aplican un estricto *Responsive Web Design* para su correcta visualización en móviles y web. A partir del Product Backlog, el trabajo se ha organizado de forma iterativa mediante Sprints.

### 5.2.1. Sprint 1

En esta sección se registra y explica el avance en términos de producto y trabajo colaborativo para el Sprint 1. Durante esta iteración inicial, el equipo se enfocó en sentar las bases de la infraestructura, implementar la interfaz visual de la Landing Page y construir el módulo núcleo de autenticación y autorización. 

#### 5.2.1.1. Sprint Planning 1

El Sprint Planning Meeting determinó el alcance técnico y operativo del primer ciclo de desarrollo. Durante la sesión, el equipo estableció las prioridades, evaluó el desempeño de las fases previas de diseño e identificó el Sprint Goal utilizando métricas SMART. A continuación, se presenta el cuadro de resumen del Sprint Planning Meeting:
...
| **Sprint n – 1 Review Summary** | Al ser el inicio de la etapa de desarrollo, el resumen anterior corresponde a la fase de diseño técnico y UX/UI. Resultados alcanzados: Diagramas de arquitectura C4 aprobados, diseño de base de datos MySQL consolidado y repositorios de GitHub inicializados. El feedback general fue positivo respecto a la estructuración de Bounded Contexts. |
| **Sprint n – 1 Retrospective Summary** | Oportunidades de mejora detectadas en la fase de diseño: El equipo acordó establecer canales de comunicación asíncrona más efectivos y aplicar rígidamente las convenciones de *GitFlow* y *Conventional Commits* desde el día 1 de código para evitar problemas de integración. |
| **Sprint Goal & User Stories** | |
| **Sprint n Goal** | **Context:** The Product Team decided to implement the foundational security architecture and establish the initial web presence of the SmartLock platform. <br><br> *"Our focus is on offering a secure authentication gateway and establishing the initial digital presence of SmartLock.* <br> *We believe it delivers a trustworthy onboarding experience to administrators and a clear value proposition to prospective customers.* <br> *This will be confirmed when administrators can successfully register and log in to the dashboard, and visitors can navigate the Landing Page without errors."* |
| **Sprint n Velocity** | 30 Story Points (Velocidad conservadora inicial para dar margen a la configuración de entornos AWS, S3 y la estructura base del código en Angular/Spring Boot). |
...
> **Leyenda:** <br>
> **L:** Líder (Líder del aspecto) <br>
> **C:** Colaborador (Colaborador y desarrollo)

#### 5.2.1.3. Sprint Backlog 1

"Nuestro objetivo ha sido consolidar el núcleo de seguridad y gestión de identidades del sistema SmartLock. De manera teórica hemos logrado la implementación de mecanismos de autenticación, aislamiento total de datos por cliente y blindaje contra ataques externos. Con esto, hemos transformado un diseño conceptual en una infraestructura técnica funcional que garantiza que solo las personas correctas tengan acceso a los recursos correctos, bajo un entorno de comunicación 100% cifrado y seguro. Esperamos que nuestros clientes tengan siempre la seguridad de que nuestro producto será 100% confiable y eficiente."

|<img src="../Resources/Herramientas/Sprint.png" alt="Estructura de prioridad" width="850"/> |
